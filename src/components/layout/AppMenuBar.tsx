...
export function AppMenuBar({ onOpenArchive, onNewArchive, onNewTome, onNewEntry, onSave, onSaveAll, onClose, onPreferences, onManageArchives }: AppMenuBarProps) {
    ...
    <MenuBar.Root>
            ...
            <MenuBar.Menu>
                ...
                <MenuBar.Portal>
                    ...
                    >
                        <MenuBar.Item>
                            <MenuBar.Label className="menubar-label" onClick={onManageArchives}>Manage Archives</MenuBar.Label>
                        </MenuBar.Item>
                    </MenuBar.Content>
                </MenuBar.Portal>
            </MenuBar.Menu>
